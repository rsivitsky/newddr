    ...
    $.jgrid = $.jgrid || {}, $.jgrid.hasOwnProperty("defaults") || ($.jgrid.defaults = {}), $.extend($.jgrid, {
        ...
        return this.each(function () {
            if (!this.grid) {
                ...
                var
                    j, k = $.jgrid.getMethod("getStyleUI"), l = d.p.styleUI + ".common", m = k(l, "disabled", !0), n = k(l, "highlight", !0), o = k(l, "hover", !0), p = k(l, "cornerall", !0), q = k(l, "icon_base", !0), r = $.jgrid.msie, s = [], t = [], u = [];
                ...
                var
                    w, x = ["shiftKey", "altKey", "ctrlKey"], y = function (a, b) {
                        ...
                        var
                            g = '<input role="checkbox" type="checkbox" id="jqg_' + d.p.id + "_" + a + '" ' + f + ' name="jqg_' + d.p.id + "_" + a + '"' + (e ? 'checked="checked"' : "") + "/>", h = z(b, c, "", null, a, !0);
                        return '<td role="gridcell" ' + h + ">" + g + "</td>"
                    }, E = function (a, b, c, d, e) {
                        var
                            f = (parseInt(c, 10) - 1) * parseInt(d, 10) + 1 + b, g = z(a, b, f, null, b, !0);
                        ...
                        if (g && (d.p.data = [], d.p._index = {}, d.p.localReader.id = h), d.p.reccount = 0, $.isXMLDoc(a)) {
                            ...
                            var
                                m, n, o, p, q, r, s, t, u, v, w = $(d), x = 0, z = d.p.multiselect === !0 ? 1 : 0, A = 0, B = d.p.rownumbers === !0 ? 1 : 0, I = [], J = {}, L = [], M = d.p.altRows === !0 ? d.p.altclass : "", N = k(l, "rowBox", !0, "jqgrow ui-row-" + d.p.direction);
                            ...
                            if (Q > 0 && d.p.page <= 0 && (d.p.page = 1), O && Q) {
                                e && (T *= e + 1);
                                var
                                    W, X = $.isFunction(d.p.afterInsertRow), Y = !1, Z = B ? k(l, "rownumBox", !1, "jqgrid-rownum") : "", _ = z ? k(l, "multiBox", !1, "cbox") : "";
                                for (d.p.grouping && (Y = d.p.groupingView.groupCollapse === !0, W = $.jgrid.getMethod("groupingPrepare")); Q > R;) {
                                    ...
                                    if (L.push(""), B && L.push(E(0, R, d.p.page, d.p.rowNum, Z)), z && L.push(D(u, B, R, !1, _)), A && L.push(p.call(w, z + B, R + b)), i.repeatitems) {
                                        ...
                                        $.each(s, function (a) {
                                            var
                                                c = ba[this];
                                            return c ? (o = c.textContent || c.text, J[d.p.colModel[a + z + A + B].name] = o, void
                                                L.push(C(u, o, a + z + A + B, R + b, t, J))) : !1
                                        })
                                    } else
                            ...
                            if (d.p.totaltime = new
                                        Date - f, x > 0 && 0 === d.p.records && (d.p.records = Q), L = null, d.p.treeGrid === !0)try {
                        ...
                        if (a) {
                            ...
                            var
                                m, o, p, q, r, s, t, u, v, w, x, z, A = $(d), B = 0, I = [], J = d.p.multiselect ? 1 : 0, L = d.p.subGrid === !0 ? 1 : 0, M = d.p.rownumbers === !0 ? 1 : 0, N = G(J + L + M), O = F(h), P = {}, Q = [], R = d.p.altRows === !0 ? d.p.altclass : "", S = k(l, "rowBox", !0, "jqgrow ui-row-" + d.p.direction);
                            ...
                            if (d.p.totaltime = new
                                        Date - f, B > 0 && 0 === d.p.records && (d.p.records = t), Q = null, d.p.treeGrid === !0)try {
                                    ...
                                    $.ajax($.extend({
                                        ...
                                        success: function (c, f, g) {
                                            return $.isFunction(d.p.beforeProcessing) && d.p.beforeProcessing.call(d, c, f, g) === !1 ? void
                                                Q() : ("xml" === b ? L(c, o, a > 1, j) : M(c, o, a > 1, j), $(d).triggerHandler("jqGridLoadComplete", [c]), i && i.call(d, c), $(d).triggerHandler("jqGridAfterLoadComplete", [c]), e && d.grid.populateVisible(), (d.p.loadonce || d.p.treeGrid) && (d.p.datatype = "local"), c = null, void(1 === a && Q()))
                                        },
                        ...
                        if ("rtl" === h && (s += t), d.p.pginput === !0 && (r = "<td id='input" + b + "' dir='" + h + "'>" + $.jgrid.template($.jgrid.getRegional(d, "defaults.pgtext", d.p.pgtext) || "", "<input class='ui-pg-input' type='text' size='2' maxlength='7' value='0' role='textbox'/>", "<span id='sp_1_" + $.jgrid.jqID(a) + "'></span>") + "</td>"), d.p.pgbuttons === !0) {
                            var
                                w = ["first" + b, "prev" + b, "next" + b, "last" + b], x = k(l, "pgButtonBox", !0, "ui-pg-button"), z = [$.jgrid.getRegional(d, "defaults.pgfirst", d.p.pgfirst) || "", $.jgrid.getRegional(d, "defaults.pgprev", d.p.pgprev) || "", $.jgrid.getRegional(d, "defaults.pgnext", d.p.pgnext) || "", $.jgrid.getRegional(d, "defaults.pglast", d.p.pglast) || ""];
                        ...
                        "ltr" === h && (s += t), s += "</tr></tbody></table>", d.p.viewrecords === !0 && $("td#" + a + "_" + d.p.recordpos, "#" + c).append("<div dir='" + h + "' style='text-align:" + d.p.recordpos + "' class='ui-paging-info'></div>"), $("td#" + a + "_" + d.p.pagerpos, "#" + c).append(s), j = $("#gbox_" + $.jgrid.jqID(d.p.id)).css("font-size") || "11px", $("#gbox_" + $.jgrid.jqID(d.p.id)).append("<div id='testpg' " + k(l, "entrieBox", !1, "ui-jqgrid") + " style='font-size:" + j + ";visibility:hidden;' ></div>"), i = $(s).clone().appendTo("#testpg").width(), $("#testpg").remove(), i > 0 && ("" !== r && (i += 50), $("td#" + a + "_" + d.p.pagerpos, "#" + c).width(i)), d.p._nvtd = [], d.p._nvtd[0] = i ? Math.floor((d.p.width - i) / 2) : Math.floor(d.p.width / 3), d.p._nvtd[1] = 0, s = null, $(".ui-pg-selbox", "#" + c).bind("change", function () {
                            ...
                            var
                                a = y(d.p.page, 1), c = y(d.p.lastpage, 1), e = !1, f = !0, g = !0, h = !0, i = !0;
                        ...
                        var
                            c, e = d.p.colModel, f = d.p.frozenColumns ? b : d.grid.headers[a].el, g = "";
                        ...
                        for (var
                                 i = 0, j = s.length; j > i; i++)i > 0 && (d.p.sortname += ", "), d.p.sortname += s[i], i !== j - 1 && (d.p.sortname += " " + t[i]);
                        d.p.sortorder = t[j - 1]
                        ...
                        var
                            a, b, c, f, g = 0, h = $.jgrid.cell_width ? 0 : y(d.p.cellLayout, 0), i = 0, j = y(d.p.scrollOffset, 0), k = !1, l = 0;
                ...
                for (i = 0; i < this.p.colNames.length; i++) {
                    ...
                    ja += "<th id='" + d.p.id + "_" + d.p.colModel[i].name + "' role='columnheader' " + k(l, "headerBox", !1, "ui-th-column ui-th-" + h) + " " + na + ">", ca = d.p.colModel[i].index || d.p.colModel[i].name, ja += "<div id='jqgh_" + d.p.id + "_" + d.p.colModel[i].name + "' " + ba + ">" + d.p.colNames[i], d.p.colModel[i].width ? d.p.colModel[i].width = parseInt(d.p.colModel[i].width, 10) : d.p.colModel[i].width = 150, "boolean" != typeof
                        d.p.colModel[i].title && (d.p.colModel[i].title = !0), d.p.colModel[i].lso = "", ca === d.p.sortname && (d.p.lastsort = i), d.p.multiSort && (u = $.inArray(ca, s), -1 !== u && (d.p.colModel[i].lso = t[u])), ja += ia + "</div></th>"
                }
                ...
                var
                    sa = $("tr:first", ja), ta = "<tr class='jqgfirstrow' role='row'>";
                if (d.p.disableClick = !1, $("th", sa).each(function (a) {
                        da = d.p.colModel[a].width, void
                            0 === d.p.colModel[a].resizable && (d.p.colModel[a].resizable = !0), d.p.colModel[a].resizable ? (ea = document.createElement("span"), $(ea).html("&#160;").addClass("ui-jqgrid-resize ui-jqgrid-resize-" + h).css("cursor", "col-resize"), $(this).addClass(d.p.resizeclass)) : ea = "", $(this).css("width", da + "px").prepend(ea), ea = null;
                        var
                            b = "";
                        d.p.colModel[a].hidden && ($(this).css("display", "none"), b = "display:none;"), ta += "<td role='gridcell' style='height:0px;width:" + da + "px;" + b + "'></td>", e.headers[a] = {
                            width: da,
                            el: this
                        }, ka = d.p.colModel[a].sortable, "boolean" != typeof
                            ka && (d.p.colModel[a].sortable = !0, ka = !0);
                        var
                ...
                var
                    va = $("<table " + k(l, "headerTable", !1, "ui-jqgrid-htable ui-common-table") + " style='width:" + d.p.tblwidth + "px' role='presentation' aria-labelledby='gbox_" + this.id + "'></table>").append(ja), wa = d.p.caption && d.p.hiddengrid === !0 ? !0 : !1, xa = $("<div class='ui-jqgrid-hbox" + ("rtl" === h ? "-rtl" : "") + "'></div>");
                ja = null, e.hDiv = document.createElement("div"), e.hDiv.style.width = e.width + "px", e.hDiv.className = k(l, "headerDiv", !0, "ui-jqgrid-hdiv"), $(e.hDiv).append(xa), $(xa).append(va), va = null, wa && $(e.hDiv).hide(), d.p.pager && ("string" == typeof
                    d.p.pager ? "#" !== d.p.pager.substr(0, 1) && (d.p.pager = "#" + d.p.pager) : d.p.pager = "#" + $(d.p.pager).attr("id"), $(d.p.pager).css({width: e.width + "px"}).addClass(k(l, "pagerBox", !0, "ui-jqgrid-pager")).appendTo(v), wa && $(d.p.pager).hide(), T(d.p.pager, "")), d.p.cellEdit === !1 && d.p.hoverrows === !0 && $(d).bind("mouseover", function (a) {
                ...
                $(d).before(e.hDiv).click(function (a) {
                    ...
                    var
                        b = $(fa).hasClass("cbox"), c = $(d).triggerHandler("jqGridBeforeSelectRow", [ga[0].id, a]);
                    if (c = c === !1 || "stop" === c ? !1 : !0, $.isFunction(d.p.beforeSelectRow)) {
                        var
                            e = d.p.beforeSelectRow.call(d, ga[0].id, a);
                        (e === !1 || "stop" === e) && (c = !1)
                    }
                    ...
                    if (fa = a.target, ga = $(fa, d.rows).closest("tr.jqgrow"), 0 !== $(ga).length) {
                        ...
                        var
                            b = $(d).triggerHandler("jqGridDblClickRow", [$(ga).attr("id"), ya, za, a]);
                        return null != b ? b : $.isFunction(d.p.ondblClickRow) && (b = d.p.ondblClickRow.call(d, $(ga).attr("id"), ya, za, a), null != b) ? b : void
                            0
                    }
                    ...
                    if (fa = a.target, ga = $(fa, d.rows).closest("tr.jqgrow"), 0 !== $(ga).length) {
                        ...
                        var
                            b = $(d).triggerHandler("jqGridRightClickRow", [$(ga).attr("id"), ya, za, a]);
                        return null != b ? b : $.isFunction(d.p.onRightClickRow) && (b = d.p.onRightClickRow.call(d, $(ga).attr("id"), ya, za, a), null != b) ? b : void
                            0
                    }
                ...
                var
                    Ba = q + " " + k(l, "icon_caption_open", !0), Ca = q + " " + k(l, "icon_caption_close", !0);
                e.cDiv = document.createElement("div");
                var
                    Da = d.p.hidegrid === !0 ? $("<a role='link' class='ui-jqgrid-titlebar-close HeaderButton " + p + "' title='" + ($.jgrid.getRegional(d, "defaults.showhide", d.p.showhide) || "") + "' />").hover(function () {
                        Da.addClass(o)
                    }, function () {
                        Da.removeClass(o)
                ...
                if ($(e.cDiv).append(Da).append("<span class='ui-jqgrid-title'>" + d.p.caption + "</span>").addClass("ui-jqgrid-titlebar ui-jqgrid-caption" + ("rtl" === h ? "-rtl" : "") + " " + k(l, "gridtitleBox", !0)), $(e.cDiv).insertBefore(e.hDiv), d.p.toolbar[0]) {
                    var
                        Ea = k(l, "customtoolbarBox", !0, "ui-userdata");
                ...
                if ($(e.hDiv).after(e.bDiv).mousemove(function (a) {
                    ...
                    var
                        Ga = "onorientationchange"in
                            window, Ha = Ga ? "orientationchange" : "resize";
    ...
    a.jgrid.extend({
        editGridRow: function (c, d) {
            ...
            return d = a.extend(!0, {
                        ...
                        if (c.length) {
                            ...
                            switch (a(this).get(0).type) {
                                ...
                                case"select-multiple":
                                    u[this.name] = a(this).val(), u[this.name] ? u[this.name] = u[this.name].join(",") : u[this.name] = "";
                                    var
                                        h = [];
                ...
                f(c, d, e, f) {
                    var
                        h, i, j, k, l, m, n, o = 0, p = [], q = !1, r = "<td class='CaptionTD'>&#160;</td><td class='DataTD'>&#160;</td>", t = "";
                    for (n = 1; f >= n; n++)t += r;
                            ...
                            if (h = this.name, i = this.editrules && this.editrules.edithidden === !0 ? !1 : this.hidden === !0 ? !0 : !1, l = i ? "style='display:none'" : "", "cb" !== h && "subgrid" !== h && this.editable === !0 && "rn" !== h) {
                                ...
                                var
                                    u = a.extend({}, this.editoptions || {}, {
                                        ...
                                        rowabove: !1,
                                        rowcontent: ""
                                    }, this.formoptions || {}), w = parseInt(v.rowpos, 10) || o + 1, x = parseInt(2 * (parseInt(v.colpos, 10) || 1), 10);
                                if ("_empty" === c && u.defaultValue && (k = a.isFunction(u.defaultValue) ? u.defaultValue.call(s) : u.defaultValue), this.edittype || (this.edittype = "text"), s.p.autoencode && (k = a.jgrid.htmlDecode(k)), m = a.jgrid.createEl.call(s, this.edittype, u, k, !1, a.extend({}, a.jgrid.ajaxOptions, d.p.ajaxSelectOptions || {})), "select" === this.edittype && (k = a(m).val(), "select-multiple" === a(m).get(0).type && k && (k = k.join(","))), "checkbox" === this.edittype && (k = a(m).is(":checked") ? a(m).val() : a(m).attr("offval")), (b[s.p.id].checkOnSubmit || b[s.p.id].checkOnUpdate) && (b[s.p.id]._savedData[h] = k), a(m).addClass("FormElement"), a.inArray(this.edittype, ["text", "textarea", "password", "select"]) > -1 && a(m).addClass(g.inputClass), F)a(L).find("#" + h).replaceWith(m); else {
                                    if (j = a(e).find("tr[rowpos=" + w + "]"), v.rowabove) {
                                        var
                                            z = a("<tr><td class='contentinfo' colspan='" + 2 * f + "'>" + v.rowcontent + "</td></tr>");
                                        a(e).append(z), z[0].rp = w
                                    }
                                    0 === j.length && (j = a("<tr " + l + " rowpos='" + w + "'></tr>").addClass("FormData").attr("id", "tr_" + h), a(j).append(t), a(e).append(j), j[0].rp = w), a("td:eq(" + (x - 2) + ")", j[0]).html("<label for='" + h + "'>" + (void
                                            0 === v.label ? d.p.colNames[n] : v.label) + "</label>"), a("td:eq(" + (x - 1) + ")", j[0]).append(v.elmprefix).append(m).append(v.elmsuffix)
                                }
                                "custom" === this.edittype && a.isFunction(u.custom_value) && u.custom_value.call(s, a("#" + h, y), "set", k), a.jgrid.bindEv.call(s, m, u), p[o] = n, o++
                            }
                        }), o > 0) {
                        var
                            u;
                        F ? (u = "<div class='FormData' style='display:none'><input class='FormElement' id='id_g' type='text' name='" + d.p.id + "_id' value='" + c + "'/>", a(L).append(u)) : (u = a("<tr class='FormData' style='display:none'><td class='CaptionTD'></td><td colspan='" + (2 * f - 1) + "' class='DataTD'><input class='FormElement' id='id_g' type='text' name='" + d.p.id + "_id' value='" + c + "'/></td></tr>"), u[0].rp = o + 999, a(e).append(u)), (b[s.p.id].checkOnSubmit || b[s.p.id].checkOnUpdate) && (b[s.p.id]._savedData[d.p.id + "_id"] = c)
                    }
                    return p
                }
                ...
                i(c, d, e) {
                    ...
                    n && (a('td[role="gridcell"]', n).each(function (h) {
                        if (f = m[h].name, "cb" !== f && "subgrid" !== f && "rn" !== f && m[h].editable === !0) {
                            ...
                            switch (s.p.autoencode && (g = a.jgrid.htmlDecode(g)), (b[s.p.id].checkOnSubmit === !0 || b[s.p.id].checkOnUpdate) && (b[s.p.id]._savedData[f] = g), f = a.jgrid.jqID(f), m[h].edittype) {
                                case"password":
                                case"text":
                                case"button":
                                case"image":
                                ...
                                case"select":
                                    ...
                                    }), (b[s.p.id].checkOnSubmit === !0 || b[s.p.id].checkOnUpdate) && (g = a("#" + f, e).val(), m[h].editoptions.multiple && (g = g.join(",")), b[s.p.id]._savedData[f] = g);
                                    break;
                                case"checkbox":
                                    ...
                                    (b[s.p.id].checkOnSubmit === !0 || b[s.p.id].checkOnUpdate) && (g = a("#" + f, e).is(":checked") ? a("#" + f, e).val() : a("#" + f, e).attr("offval"), b[s.p.id]._savedData[f] = g);
                                    break;
                                case"custom":
                                    try {
                    ...
                    }), l > 0 && (a("#id_g", A).val(c), (b[s.p.id].checkOnSubmit === !0 || b[s.p.id].checkOnUpdate) && (b[s.p.id]._savedData[d.p.id + "_id"] = c)))
                }
                            ...
                            v = a.extend({
                                ...
                                complete: function (g, j) {
                                    ...
                                    if (a("#sData", A + "_2").removeClass(h.active), u[e] = s.p.idPrefix + u[e], g.status >= 300 && 304 !== g.status ? (n[0] = !1, n[1] = a(s).triggerHandler("jqGridAddEditErrorTextFormat", [g, w]), a.isFunction(b[s.p.id].errorTextFormat) ? n[1] = b[s.p.id].errorTextFormat.call(s, g, w) : n[1] = j + " Status: '" + g.statusText + "'. Error code: " + g.status) : (n = a(s).triggerHandler("jqGridAddEditAfterSubmit", [g, u, w]), void
                                        ...
                                        }, 500)), (b[s.p.id].checkOnSubmit || b[s.p.id].checkOnUpdate) && (a(y).data("disabled", !1), "_empty" !== b[s.p.id]._savedData[s.p.id + "_id"]))for (l
                                        in
                                        b[s.p.id]._savedData)b[s.p.id]._savedData.hasOwnProperty(l) && u[l] && (b[s.p.id]._savedData[l] = u[l]);
                ...
                m() {
                    var
                        c = !0;
                    return a(".FormError", y).hide(), b[s.p.id].checkOnUpdate && (u = {}, e(), v = l(u, b[s.p.id]._savedData), v && (a(y).data("disabled", !0), a(".confirm", "#" + B.themodal).show(), c = !1)), c
                }
                ...
                p() {
                    var
                        b = a(s).jqGrid("getDataIDs"), c = a("#id_g", A).val(), d = a.inArray(c, b);
                    return [d, b]
                }
                    ...
                    if (b[s.p.id].checkOnSubmit || b[s.p.id].checkOnUpdate) {
                        ...
                        c = a.map(b[s.p.id]._savedData, function (a, b) {
                            ...
                            if (-1 === c.indexOf(this.name)) {
                                var
                                    e = a(this).val(), f = a(this).get(0).type;
                                if ("checkbox" === f)a(this).is(":checked") || (e = a(this).attr("offval")); else if ("select-multiple" === f)e = e.join(","); else if ("radio" === f) {
                                    if (d.hasOwnProperty(this.name))return !0;
                                    d[this.name] = void
                                        0 === a(this).attr("offval") ? "off" : a(this).attr("offval")
                                }
                ...
                if (s.grid && c) {
                    ...
                    if (F ? (I = q(b[a(this)[0].p.id].template), t = A) : (I = a("<table id='" + z + "' class='EditTable ui-common-table'><tbody></tbody></table>"), t = A + "_2"), y = "#" + a.jgrid.jqID(y), a(L).append("<div class='FormError " + h.error + "' style='display:none;'></div>"), a(L).append("<div class='tinfo topinfo'>" + b[s.p.id].topinfo + "</div>"), a(s.p.colModel).each(function () {
                        ...
                        a(s).triggerHandler("jqGridAddEditInitializeForm", [a(y), w]), a.isFunction(b[s.p.id].onInitializeForm) && b[s.p.id].onInitializeForm.call(s, a(y), w), "_empty" !== c && b[s.p.id].viewPagerButtons ? a("#pData,#nData", t).show() : a("#pData,#nData", t).hide(), a(s).triggerHandler("jqGridAddEditBeforeShowForm", [a(y), w]), a.isFunction(b[s.p.id].beforeShowForm) && b[s.p.id].beforeShowForm.call(s, a(y), w), r(), a("#" + a.jgrid.jqID(B.themodal)).data("onClose", b[s.p.id].onClose), a.jgrid.viewModal("#" + a.jgrid.jqID(B.themodal), {
                            ...
                            return u = {}, a(".FormError", y).hide(), e(), "_empty" === u[s.p.id + "_id"] ? k() : d.checkOnSubmit === !0 ? (v = l(u, b[s.p.id]._savedData), v ? (a(y).data("disabled", !0), a(".confirm", "#" + a.jgrid.jqID(B.themodal)).show()) : k()) : k(), !1
                            ...
                            if (b[0] = parseInt(b[0], 10), -1 !== b[0] && b[1][b[0] + 1]) {
                                a(s).triggerHandler("jqGridAddEditClickPgButtons", ["next", a(y), b[1][b[0]]]);
                                var
                                    c;
                                if (a.isFunction(d.onclickPgButtons) && (c = d.onclickPgButtons.call(s, "next", a(y), b[1][b[0]]), void
                                        0 !== c && c === !1))return !1;
                                if (a("#" + a.jgrid.jqID(b[1][b[0] + 1])).hasClass(h.disabled))return !1;
                                i(b[1][b[0] + 1], s, y), a(s).jqGrid("setSelection", b[1][b[0] + 1]), a(s).triggerHandler("jqGridAddEditAfterClickPgButtons", ["next", a(y), b[1][b[0]]]), a.isFunction(d.afterclickPgButtons) && d.afterclickPgButtons.call(s, "next", a(y), b[1][b[0] + 1]), r(), o(b[0] + 1, b)
                            }
                            return !1
                            ...
                            var
                                b = p();
                            if (-1 !== b[0] && b[1][b[0] - 1]) {
                                a(s).triggerHandler("jqGridAddEditClickPgButtons", ["prev", a(y), b[1][b[0]]]);
                                var
                                    c;
                                if (a.isFunction(d.onclickPgButtons) && (c = d.onclickPgButtons.call(s, "prev", a(y), b[1][b[0]]), void
                                        0 !== c && c === !1))return !1;
                                if (a("#" + a.jgrid.jqID(b[1][b[0] - 1])).hasClass(h.disabled))return !1;
                                i(b[1][b[0] - 1], s, y), a(s).jqGrid("setSelection", b[1][b[0] - 1]), a(s).triggerHandler("jqGridAddEditAfterClickPgButtons", ["prev", a(y), b[1][b[0]]]), a.isFunction(d.afterclickPgButtons) && d.afterclickPgButtons.call(s, "prev", a(y), b[1][b[0] - 1]), r(), o(b[0] - 1, b)
                            }
                            return !1
            ...
            return b = a.extend({
                ...
                if (!d.p.filterToolbar) {
                    ...
                    b.restoreFromFilters && (g = d.p.postData.filters, g && ("string" == typeof
                        ...
                        var
                            c = a(this).parents("tr:first"), e = parseInt(a("td.ui-search-oper", c).attr("colindex"), 10), f = a.extend({}, d.p.colModel[e].searchoptions || {}), g = f.defaultValue ? f.defaultValue : "";
            ...
            return this.each(function () {
                ...
                if (d.grid) {
                    ...
                    var
                        q = d.rows.length, r = 1;
                    for (void
                             0 !== c && c > 0 && (r = c, q = c + 1); q > r;)a(d.rows[r]).hasClass("jqgrow") && (d.p.scroll && a(d.rows[r].cells[b]).unbind("click"), a(d.rows[r].cells[b]).bind("click", function () {
                        var
        ...
        setTreeNode: function (b, c) {
            return this.each(function () {
                ...
                if (d.grid && d.p.treeGrid)for (var
                                                    e, f, g, h, i, j, k, l, m = d.p.expColInd, n = d.p.treeReader.expanded_field, o = d.p.treeReader.leaf_field, p = d.p.treeReader.level_field, q = d.p.treeReader.icon_field, r = d.p.treeReader.loaded, s = a.jgrid.styleUI[d.p.styleUI || "jQueryUI"].common; c > b;) {
                    var
                        t, u = a.jgrid.stripPref(d.p.idPrefix, d.rows[b].id), v = d.p._index[u];
            ...
            return this.each(function () {
                if (this.grid && this.p.treeGrid) {
                    var
                        c = this.p.localReader.id, d = this.p.selrow;
                    a(this).jqGrid("delChildren", b[c]);
                    var
                        e = this.p.treeReader.expanded_field, f = this.p.treeReader.parent_id_field, g = this.p.treeReader.loaded, h = this.p.treeReader.level_field, i = this.p.treeReader.left_field, j = this.p.treeReader.right_field, k = a.jgrid.getAccessor(b, this.p.localReader.id), l = a("#" + k, this.grid.bDiv)[0];
